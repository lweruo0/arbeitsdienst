...
$getoutputfile = admFuncVariableIsValid($_GET,
                                        'outputfile',
                                        'array');
    ...
    switch ($getForm) {
        case 'controlexport':
            ...
            if (isset($_POST['btn_export_control']) && ($gettypeofoutput == '')) // Ausgabe im PDF Format
            {
                ...
                $url = SecurityUtils::encodeUrl($gNavigation->getUrl(), 
                                              array('show_option' => 'controlexport'));
            }
            ...
            */
            ...
            if (($gettypeofoutput == 'CSVALL') || ($gettypeofoutput == 'CSVPAY')) // Ausgabe im CSV Format
            {
